...
function sum(a, b) { //eslint-disable-line
  var c = a + b;
  var sum= c;
  var string = 'The sum of '+a+' and '+b+' is '+c+'.';
  return [sum,string];
}
...
function multiply(a, b) { //eslint-disable-line
  var c = a* b;
  var output = c;
  var string = 'The product of '+a+' and '+b+' is '+c+'.';
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var e = sum(d[0], c);
  var f = multiply(a, b);
  var g = multiply(f[0],c);
  var sums = e[0];
  var multiples = g[0];
  var additionstring = a+" and "+b+" and "+c+" sum to "+sums+".";
  var multipleString = "The product of "+a+" and "+b+" and "+c+" is "+multiples+ ".";
  return ([sums, multiples, additionstring, multipleString]);
}
...
function multiplyArray(multArr) { //eslint-disable-line
  var arrayMult = 1
    for (var i = (multArr.length -1); i >= 0 ; i--) {
      arrayMult = multiply(arrayMult, multArr[i]);
      arrayMult = arrayMult[0];
    }
    // The numbers 2,3,4 have a product of 24.
    var firstString = "The numbers ";
    var secondString = " have a product of ";
    var string = (firstString + multArr + secondString + arrayMult + '.');
